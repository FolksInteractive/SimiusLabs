...
Template["afFormGroup_folks"].helpers({
  ...
  afFieldLabelAtts: function () {
    ...
    atts = AutoForm.Utility.addClass(atts, "col-sm-2");
    // Add bootstrap class
...
Template["afObjectField_folks"].helpers({
  rightColumnClass: function () {
    var atts = this.atts || {};
    return atts['input-col-class'] || "col-sm-10";
  },
  afFieldLabelAtts: function () {
    ...
    labelAtts = AutoForm.Utility.addClass(labelAtts, "col-sm-2");
...
Template["afArrayField_folks"].helpers({
  rightColumnClass: function () {
    var atts = this.atts || {};
    return atts['input-col-class'] || "col-sm-10";
  },
...
Template["afCheckbox_folks"].helpers({
